...
object Request {
    ...
    fun getRequest(path :String, params:MutableMap<String,String>, callback: CustomCallback, context: Context){
        val call= service.Getrequest(path,params)
        call.enqueue(
            calll(
                callback,
                context
    ...
    interface Apiservice {
        ...
        @GET("place/{path}/json")
        fun Getrequest(@Path("path") path: String, @QueryMap params:MutableMap<String,String>): Call<String>
    }
}